...
import * as MapLinesActions from '../map/actions';
    ...
    return Firebase.auth()
      ...
      .then((res) => {
        if (res && res.uid) {
          ...
          // Get Favourites
          MapLinesActions.getFavourites(dispatch);
...
export function logout() {
  ...
  return dispatch => Firebase.auth()
    ...
    .then(() => {
      ...
      MapLinesActions.resetFavourites(dispatch);
      FavouritesActions.resetFavourites(dispatch);
