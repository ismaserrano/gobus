...
class Menu extends Component {
  static propTypes = {
    ...
    additionalMenu: PropTypes.arrayOf(PropTypes.shape({})),
  }
    ...
    if (this.props.logout) {
      this.props.logout()
        .then(() => {
          ...
          Alert.alert('Ups!', 'Algo ha ido mal');
        });
    }
  }
  ...
  menuList = () => {
    ...
    menu = menu.concat(this.props.additionalMenu);
          ...
          {this.props.user && this.props.user.email ?
            <View>
              ...
              <View style={[AppStyles.paddingHorizontal, AppStyles.paddingVerticalSml]}>
                <Button small title={'Salir'} onPress={this.logout} />
              </View>
            </View>
          :
            <View style={[AppStyles.paddingHorizontal, AppStyles.paddingVerticalSml]}>
              <Button small title={'Acceder'} onPress={() => this.onPress(Actions.login)} />
            </View>
          }
        </View>
      </View>
